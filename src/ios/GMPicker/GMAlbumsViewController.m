...
//    self.tableView.separatorStyle = UITableViewCellSeparatorStyleSingleLineEtched;
    ...
    NSString *cancelTitle = self.picker.customCancelButtonTitle ? self.picker.customCancelButtonTitle : @"Cancel";
    ...
    if (self.picker.allowsMultipleSelection) {
        NSString *doneTitle = self.picker.customDoneButtonTitle ? self.picker.customDoneButtonTitle : @"Done";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Set the label
    cell.textLabelNew.font = [UIFont fontWithName:self.picker.pickerFontName size:self.picker.pickerFontHeaderSize];
    cell.textLabelNew.text = (self.collectionsFetchResultsTitles[indexPath.section])[indexPath.row];
    cell.textLabelNew.textColor = self.picker.pickerTextColor;
    ...
    if (self.picker.displayAlbumsNumberOfAssets) {
        cell.detailLabelNew.font = [UIFont fontWithName:self.picker.pickerFontName size:self.picker.pickerFontNormalSize];
        cell.detailLabelNew.text = [self tableCellSubtitle:assetsFetchResult];
        cell.detailLabelNew.textColor = self.picker.pickerTextColor;
    }
