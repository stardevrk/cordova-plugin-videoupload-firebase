...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        float labelWidth = kPopoverContentSize.width - kAlbumThumbnailSize1.width - kAlbumLeftToImageSpace - kAlbumImageToTextSpace;
        float labelOffset = kAlbumLeftToImageSpace + kAlbumImageToTextSpace + kAlbumThumbnailSize1.width;
        _textLabelNew = [UILabel new];
        _textLabelNew.frame = CGRectMake(labelOffset , 15, labelWidth, 15);
        _textLabelNew.text = self.text;
        [self.contentView addSubview:(UIView *)_textLabelNew];
        
        _detailLabelNew = [UILabel new];
        
        _detailLabelNew.frame = CGRectMake(labelOffset+4 , 40, labelWidth-4, 15);
        _detailLabelNew.text = self.detail;
        [self.contentView addSubview:(UIView *)_detailLabelNew];
